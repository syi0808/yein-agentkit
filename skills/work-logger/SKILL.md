...
Output: `docs/work-logs/YYYY-MM-DD-short-description.md`
...
uv run .claude/skills/sqlite-vectordb/scripts/add_entry.py \
  --file "docs/work-logs/YYYY-MM-DD-short-description.md" \
...
# Step 2: Edit docs/work-logs/2026-01-16-add-user-auth.md

# Step 3: Index
uv run .claude/skills/sqlite-vectordb/scripts/add_entry.py \
  --file "docs/work-logs/2026-01-16-add-user-auth.md" \
