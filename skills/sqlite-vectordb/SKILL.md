...
uv run .claude/skills/sqlite-vectordb/scripts/add_entry.py \
  --file "docs/work-logs/YYYY-MM-DD-slug.md" \
...
- **DB location**: `docs/work-logs/.vector-db/work-logs.db`
...
**Common fixes**:
- DB corrupted: Delete `docs/work-logs/.vector-db/work-logs.db` and re-run (auto-recreates)
...
uv run .claude/skills/sqlite-vectordb/scripts/add_entry.py \
  --file "docs/work-logs/2026-01-16-auth-feature.md" \
